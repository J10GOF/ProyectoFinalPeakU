<template>
  <section
    class="exclusive-deals mb-5"
    style="position: relative; background: #fefcfb"
  >
    <div class="container">
      <div class="row">
              ...
              <div class="card bg-light border-0">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center justify-content-left">
                    <img
                      src="../assets/deals/Vector(1).png"
                      alt="vector-point"
                      class="mr-3"
                      style="margin-right: 5px; width: 10px"
                    />
                  ...
                  >
                    ...
                    <span
                      ...
                      style="color: #fa7436; background-color: #ffe7db"
                      >{{ deal.discountedPrice }}</span
                    >
                  </div>
                </div>
              </div>
      ...
      <div class="row mt-3 mb-5">
        <div class="col-12 text-center" style="margin-bottom: 200px">
          ...
          >
            <span
              ><img src="../assets/deals/arrow-left.svg" style="width: 20px"
            /></span>
          </button>
          <button
            class="btn btn-dark rounded-circle"
            style="width: 40px; height: 40px; background-color: #fefcfb"
            @click="nextSlide"
          >
            <span
              ><img
                src="../assets/deals/arrow-right.svg"
...
export default {
  ...
  data() {
    return {
      ...
      currentPosition: 0,
      cardsToShow: 3,
      showAlert: false, // Bandera para mostrar la alerta
    };
  },
  computed: {
    visibleDeals() {
  ...
  computed: {
    visibleDeals() {
      ...
      const startIndex = this.currentPosition;
      const endIndex = startIndex + this.cardsToShow;
      const visibleDeals = this.deals.slice(startIndex, endIndex);

      // Muestra la alerta si no hay ofertas visibles
      this.showAlert = visibleDeals.length === 0;
